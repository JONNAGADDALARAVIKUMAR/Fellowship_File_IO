...
public class AddressBookManupulator {
	...
	String file = HOME + "/AddressBookFile/ADDRESSBOOK.txt";
	...
	public void saveToFile(String file, DetailsCollector detailsCollector, boolean saveCondition) {
		try {
	...
	private void addToSortedFile(List<DetailsCollector> sortedList, String sortByNameFile) {
		try {
